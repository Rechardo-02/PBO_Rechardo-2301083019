...
public class FormCalculator1 extends javax.swing.JFrame {
    String angka;
    double jumlah, bil1, bil2;
    int pilih;

    public FormCalculator1() {
        initComponents();
        angka = "";
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCalculator1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCalculator1().setVisible(true);
            }
        });
    }
