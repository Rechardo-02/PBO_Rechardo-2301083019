...
public class AnggotaController {
    ...
    public void clearForm() {
        ...
        formAnggota.getCboJenisKelamin().removeAllItems(); // Perbaikan removeAllItems()
        formAnggota.getCboJenisKelamin().addItem("L");
        formAnggota.getCboJenisKelamin().addItem("P"); // Perbaikan nilai "P" (huruf besar)
    }
    ...
    public void getAnggota(){
        ...
        if(anggota!=null){
            ...
            formAnggota.getCboJenisKelamin().setToolTipText(anggota.getJenisKelamin());
        }
    }
    public void tampil(){
